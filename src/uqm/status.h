...
#define GAUGE_YOFFS ((SHIP_INFO_HEIGHT - RES_SCALE(10) + 6 * RESOLUTION_FACTOR) - IF_HD(4)) // JMS_GFX
#define UNIT_WIDTH RES_SCALE(2)
#define UNIT_HEIGHT RES_SCALE(1)
#define STAT_WIDTH (1 + UNIT_WIDTH + 1 + UNIT_WIDTH + 1)

#define SHIP_INFO_HEIGHT RES_SCALE(65) // JMS_GFX
...
#define CAPTAIN_YOFFS (SHIP_INFO_HEIGHT + RES_SCALE(4)) // JMS_GFX

#define SHIP_STATUS_HEIGHT (STATUS_HEIGHT >> 1)
#define BAD_GUY_YOFFS 0
#define GOOD_GUY_YOFFS SHIP_STATUS_HEIGHT

#define STARCON_TEXT_HEIGHT RES_SCALE(7) // JMS_GFX
#define TINY_TEXT_HEIGHT RES_SCALE(9) // JMS_GFX
#define BATTLE_CREW_X RES_STAT_SCALE(10) // JMS_GFX
#define BATTLE_CREW_Y (RES_SCALE(64) - IF_HD(4))// JMS_GFX
