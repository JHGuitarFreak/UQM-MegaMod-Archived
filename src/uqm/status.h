...
#define GAUGE_YOFFS ((SHIP_INFO_HEIGHT - (10 << RESOLUTION_FACTOR) + 6 * RESOLUTION_FACTOR) - RES_BOOL(0,4)) // JMS_GFX
...
#define BATTLE_CREW_Y (((64 - SAFE_Y) << RESOLUTION_FACTOR) - RES_BOOL(0,4))// JMS_GFX
