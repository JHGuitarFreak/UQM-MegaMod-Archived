...
#define DRIVE_TOP_X ((33 << RESOLUTION_FACTOR) + RES_BOOL(0, 100)) // JMS_GFX
#define DRIVE_TOP_Y ((86 << RESOLUTION_FACTOR) - RES_BOOL(0, 73)) // JMS_GFX

#define JET_SIDE_X ((71 << RESOLUTION_FACTOR)) // JMS_GFX
#define JET_SIDE_Y ((48 << RESOLUTION_FACTOR)) // JMS_GFX
#define JET_TOP_X ((70 << RESOLUTION_FACTOR) + RES_BOOL(0, 86)) // JMS_GFX
#define JET_TOP_Y ((94 << RESOLUTION_FACTOR) - RES_BOOL(0, 120)) // JMS_GFX

#define MODULE_SIDE_X ((17 << RESOLUTION_FACTOR) + RES_BOOL(0, 55)) // JMS_GFX
#define MODULE_SIDE_Y ((14 << RESOLUTION_FACTOR) - RES_BOOL(0, 5)) // JMS_GFX
#define MODULE_TOP_X ((17 << RESOLUTION_FACTOR) + RES_BOOL(0, 55)) // JMS_GFX
#define MODULE_TOP_Y ((117 << RESOLUTION_FACTOR) + RES_BOOL(0, 59)) // JMS_GFX

#define SHIP_PIECE_OFFSET ((12 << RESOLUTION_FACTOR) - RES_BOOL(0, 2)) // JMS_GFX
